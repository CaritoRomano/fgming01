...
<div id="links">
    <a href="{{ asset('images/01.jpg') }}" title="Foto 1" data-gallery>
        <img src="{{ asset('images/thumbnails/01 - Thumbnails.jpg') }}" alt=" "> <!-- completar alt -->
    </a>
    <a href="{{ asset('images/02.jpg') }}" title="Foto 2" data-gallery>
        <img src="{{ asset('images/thumbnails/02 - Thumbnails.jpg') }}" alt=" ">
    </a>
    <a href="{{ asset('images/03.jpg') }}" title="Foto 3" data-gallery>
        <img src="{{ asset('images/thumbnails/03 - Thumbnails.jpg') }}" alt=" ">
    </a>
    <a href="{{ asset('images/04.jpg') }}" title="Foto 2" data-gallery>
        <img src="{{ asset('images/thumbnails/04 - Thumbnails.jpg') }}" alt=" ">
    </a>
    <a href="{{ asset('images/05.jpg') }}" title="Foto 3" data-gallery>
        <img src="{{ asset('images/thumbnails/05 - Thumbnails.jpg') }}" alt=" ">
    </a>
    <a href="{{ asset('images/06.jpg') }}" title="Foto 3" data-gallery>
        <img src="{{ asset('images/thumbnails/06 - Thumbnails.jpg') }}" alt=" ">
    </a>
    <a href="{{ asset('images/07.jpg') }}" title="Foto 2" data-gallery>
        <img src="{{ asset('images/thumbnails/07 - Thumbnails.jpg') }}" alt=" ">
    </a>
</div>
<div>
