    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item" align="center">
          <img class="first-slide" src="{{ asset('/images/slider/cons') }}" alt="Primer imagen del slide">
          <div class="container">
        ...
        <div class="item active" align="center">
          <img class="second-slide" src="{{ asset('/images/slider/cons') }}" alt="Segunda imagen del slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Diseños asistidos por computadora</h1>
              ...
              <p><a class="btn btn-lg btn-primary" href="{{ url('servicio/1') }}" role="button">Ver mas</a></p>
            </div>
          </div>
        </div>
        <div class="item" align="center">
          <img class="third-slide" src="{{ asset('/images/slider/fem') }}" alt="Tercer imagen del slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Análisis por método de elementos finitos</h1>
              ...
              <p><a class="btn btn-lg btn-primary" href="{{ url('servicio/2') }}" role="button">Ver mas</a></p>
            </div>
          </div>
        </div>
      </div>
